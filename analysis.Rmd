...
for (i in 1:20) {
  ...
  word_scores = colSums(lda_model$topics[which_topics,])
...
y = round(80 * y / max(y),2) + 10

# get the colors by the cluster ordering
cols = cluster_colors[cluster_data$cluster_20]

write(file='index.html',paste('<html><head></head><body><script>clusters=',toJSON(wordsdata),
                                               '</script><div id="scatter"><div class="container" style="width:100vw;height:100vh;">',
